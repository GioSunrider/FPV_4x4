...
void setup()
{
  ...
  /*
  YAW_IN_PIN.begin(true);
  THROTTLE_IN_PIN.begin(true);
  START_STOP_IN_PIN.begin(true);
   */ 
  //Direction
...
void loop()
{
  ...
  //attachInterrupt(START_STOP_IN_PIN, ISR, CHANGE);
  ...
  /*
  digitalRead(THROTTLE_DURATION);
  Serial.println("IN THROTTLE");
  ...
  */
  ...
  Direction.write(30);
  /*
  digitalRead(YAW_DURATION);
  Serial.println("IN YAW");
  Serial.println(YAW_DURATION);
  */
